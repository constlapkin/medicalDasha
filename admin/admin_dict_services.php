...
$a_direct = 'admin_dict_services.php?page=';
$a_direct_1 = 'admin_dict_services.php?page=1';
$count = R::getCell("Select Count(*) from dictservices;");
if($count % $limit > 0){
...
if($curPage > 1){
    ...
    $dicts = R::find('dictservices', ' LIMIT :start, :limit ',
        array(
            ':start' => $start,
            ':limit' => $limit
        ));
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-md-4"><a href="add_dict_service.php"><p class="add"><i data-feather="plus"></i>Add</p></a></div>
    </div>
    <hr>
    <div class="row">
        ...
        foreach ($dicts as $dict_row){
            echo ('
                <div class="row">
                    ...
                    <div class="col-md-11"><a href="edit_dict_service.php?id='.$dict_row['id'].'">'.$dict_row['type'].'</a></div>
                </div>
                <hr>
            ');
        }
